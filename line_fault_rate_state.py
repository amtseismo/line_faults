...
# Call the ODE solver.
if o['sl']:
    wsol = solve_ivp(lambda t, y: ratestate_sl(t, y, o), [0,5e7], y0, max_step=1000000, rtol=10e-10, atol=10e-10)
else:
    wsol = solve_ivp(lambda t, y: ratestate_al(t, y, o), [0,5e7], y0, max_step=1000000, rtol=10e-10, atol=10e-10)
